...
port = 4000  # Set this to your desired port number
...
class MyHandler(FileSystemEventHandler):
    def on_modified(self, event):
        ...
        if not is_inside_hidden_directory(event.src_path):
...
server = None
share_screen = False  # False is default. Will only be True when a message is received from the ITLMS
